...
(defined $ARGV[3]) ||
    die "Usage:  cbcvg.pl  <method [rvet|ivet|entr|pheno|det]>  <specs score file>  <pdb_file_full_path>  <output name> [<chain> and/or -r and/or -b] \n"; 
...
($almt, $pdb_id, $aa, $gaps, $ent, $rv, $iv, $ent_s, 
 $rv_s, $iv_s, $pheno, $det, $substitutions) = ();
...
while ( <RANKS_FILE> ) {
    ...
    chomp;
    ($almt, $pdb_id, $aa, $gaps, $ent, $rv, $iv, $ent_s, 
     $rv_s, $iv_s, $pheno, $det, $substitutions) = split;
