...
sub rationale ( @) { 
	...
	} elsif (  defined $options{"STRUCT"} ) {
	    $tex_string .= "we use the structure ".  $options{"STRUCT"}.", provided by the user of report\\\_maker.\n";
	} else {
    ...
    if ( ! defined $options{"MODEL"} && ! $options{"STRUCT"}  ) {
