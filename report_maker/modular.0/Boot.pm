...
sub boot () {
    ...
    $path{"pdbids"}          =   "/home/pine/databases/pdbseq/pdbaa.pdb_ids";  
    $path{"scratchdir"}      =   "/tmp";  
...
sub read_options ( @) {
    ...
    my @option_kwds = (  "NAME", "SEQ","FASTA", "ALMT", "PDBF", "MODEL", "MODEL_ALMT", 
			 "DESCR", "BLAST_EVAL", "MAX_ID", "PID_LOWEST");
    ...
    #  4) NAME is recognizable as id ---> prceed by finding db input, doing blast, etc
    #  5) failure
